-- Sistema para registrar reciclajes, recompensar a usuarios y medir su impacto ambiental.
CREATE SCHEMA IF NOT EXISTS sistema_reciclaje DEFAULT CHARACTER SET utf8mb4;
USE sistema_reciclaje;

-- Tabla usuarios
-- Contiene la información personal de los usuarios registrados en el sistema.
...
-- Tabla puntos_reciclajes
-- Registra los lugares habilitados para depositar materiales reciclables.
...
-- Tabla reciclajes
-- Almacena cada acción de reciclaje realizada por los usuarios en los puntos.
...
-- Tabla recompensas
-- Define los premios disponibles que los usuarios pueden canjear con puntos.
...
-- Tabla canjes
-- Guarda el historial de canjes de recompensas hechos por los usuarios.
...
-- Mide el impacto generado por los reciclajes, como kg reciclados y CO2 evitado.
...
-- Tabla descuentos
-- Lista descuentos especiales asociados a ciertas recompensas.
...
-- Tabla roles
-- Define distintos roles de usuario en el sistema (por ejemplo, administrador).
...
-- Tabla puntajes
-- Controla los puntos ganados y gastados por los usuarios a lo largo del tiempo.
...
-- Tabla usuario_roles
-- Relaciona usuarios con sus respectivos roles en el sistema.
...
-- Enumera los tipos de materiales reciclables y los puntos que otorgan por kg.
...
-- Tabla listas_materiales
-- Detalla los materiales específicos reciclados en cada evento de reciclaje.
...
-- Tabla donaciones
-- Registra donaciones monetarias hechas por los usuarios.
...
-- Tabla punto_tipos_materiales
-- Indica qué tipos de materiales acepta cada punto de reciclaje.
